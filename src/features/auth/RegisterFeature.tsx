      ...
      >
        ...
        <div className="w-full md:w-[55%] p-8 md:p-12 lg:p-16 flex flex-col">
          ...
          <div className="flex justify-center items-center">
            <motion.button
              whileHover={{ y: -2 }}
              className="px-5 flex items-center justify-center gap-3 h-12 bg-brand-input border border-gray-100 rounded-xl hover:bg-gray-100 transition-all font-medium text-sm text-gray-700"
            >
